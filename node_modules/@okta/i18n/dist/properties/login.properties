...
##
##  @okta/i18n, https://github.com/okta/npm/tree/master/i18n, 06/16/2017
##
#############################################################################################
#############################################################################################
...
# Last translated sha - 983d3dac0934d1dff8785f99322bdba03b4d9a5b
...
registration.error.userName.doesNotMatchPattern=Value does not match pattern
...
deviceTrust.sso.hint = Easily get company resources using Okta Mobile to sign in to apps from your secure device.
deviceTrust.sso.button = Sign in using Okta Mobile
...
# DELETED KEYS
# If you're making a breaking change (i.e. removing a key or modifying an existing key), add the key to this section instead. When modifying keys:
# 1. Create a new name for the key and add your modified string to that property
# 2. Add the old property to this section
# We will be periodically cleaning up this section and removing old keys. This will help reduce the churn in major version numbers in okta-core.
registration.emailSent.title=Verification email sent
registration.emailSent.desc=We just sent a verification email to {0}. Please check your email and verify your account to continue.